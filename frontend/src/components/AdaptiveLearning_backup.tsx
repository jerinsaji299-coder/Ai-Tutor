...
const AdaptiveLearning: React.FC<AdaptiveLearningProps> = ({ teachingPlan }) => {
  ...
  const generateKnowledgeTest = async () => {
    ...
    try {
      ...
      console.log('🧠 Generating knowledge test from syllabus...', syllabusData);
      ...
      console.log('✅ Knowledge test generated:', data);
      ...
      console.error('❌ Knowledge test generation error:', err);
  ...
  const tabs = [
    { id: 'knowledge-test', label: 'Knowledge Test', icon: Brain },
            ...
            <div className="space-y-6">
              ...
              {teachingPlan && teachingPlan.weeks && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-blue-700 mt-3">
                    🎯 Knowledge test will focus on the first 3-6 weeks of content to assess your understanding of foundational concepts.
                  </p>
                </div>
              )}
              ...
              {knowledgeTest.length > 0 && (
                <div className="space-y-4">
                  <h4 className="font-medium text-gray-800">Answer the following questions:</h4>
                    ...
                    <div key={question.id || index} className="bg-gray-50 p-4 rounded-lg">
                      ...
                      {question.type === 'multiple-choice' && question.options ? (
                        ...
                        <textarea
                          ...
                          value={studentAnswers[question.id || index] || ''}
                          onChange={(e) => {
                            setStudentAnswers((prev: any) => ({
                              ...prev,
                              [question.id || index]: e.target.value
                  ...
                  >
                    ...
                    {loading ? 'Analyzing Performance...' : `Submit Test & Analyze Performance (${Object.keys(studentAnswers).length}/${knowledgeTest.length} answered)`}
                  </button>
                </div>
              )}
            </div>
            ...
            <div className="space-y-6">
              {!performance ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Complete a knowledge test to see your performance analysis</p>
                </div>
              ) : (
                <div className="space-y-6">
                  <h3 className="text-lg font-semibold flex items-center gap-2">
                    <TrendingUp className="h-5 w-5 text-green-500" />
                    Syllabus-Based Performance Analysis
                  </h3>
                  ...
                  <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-6 rounded-lg text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm opacity-90">Based on {teachingPlan?.subject || 'course'} syllabus content</p>
                      </div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-yellow-800 mb-3">📝 Syllabus-Based Recommendations</h4>
          ...
          {(activeTab === 'feedback' || activeTab === 'adaptive-syllabus') && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">
                {activeTab === 'feedback' ? 'Feedback collection' : 'Adaptive syllabus generation'} coming soon...
              </p>
            </div>
          )}
        </div>
